...
34 `confirm-this` flags across the cards plus 5 open issues reads as 39 threads. Grouped by *what would actually resolve them*, it's about **six** (card 057):
...
| Small standalone trials | cards 003, 006, 012, 016, 020, 059, 062, 064, 067 | hours each |
