...
**Source:** Beta raised the safety-layer question in the 2026-09-11 session; verified against the Claude API reference (model catalog, Fable 5 section, `stop_details` refusal categories). **Corrected the same day** by Dave's own experience — this card initially overclaimed.
