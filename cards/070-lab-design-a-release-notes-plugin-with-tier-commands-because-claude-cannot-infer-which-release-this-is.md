...
**Type:** decision
**Verified:** `ran-it` — **built**, 2026-09-17, at `~/watchtower/labs/release-notes-plugin`. Authored, installed and invoked headlessly against real tag ranges. The build resolved the gate and corrected Ruling 1's mechanism (below).
