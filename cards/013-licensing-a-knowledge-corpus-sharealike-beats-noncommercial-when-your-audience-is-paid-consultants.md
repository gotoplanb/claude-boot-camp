...
**A deliberate asymmetry, for contrast:** Dave's *tool* repos default to **MIT-0** — no attribution, no conditions, nothing (card 054). That looks inconsistent beside BY-SA until you notice they answer different questions. BY-SA here is a considered choice about how ideas propagate and stay open. MIT-0 there is a choice to stop thinking about the question at all, and to foreclose the "maybe this becomes a product" future that pulls a tool toward premature generalisation. **Pick the licence for what you want it to do to the work — including what you want it to do to you.**
